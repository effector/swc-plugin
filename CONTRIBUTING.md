...
This plugin supports `swc_core@80.0.0+` and `@swc/core@1.16.0+` with stable Plugin ABI (v2) and targets the _latest_ version available. Breaking changes in Plugin ABI by SWC require a major version bump.
